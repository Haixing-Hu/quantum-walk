%QUANTUM_WALK_1D_WAVE Generates the animation of the probability wave of
%                   continuous-time quantum walks on a line.
%
%  QUANTUM_WALK_1D_WAVE(n, T) Generates the animation of the probability 
%                   wave of continuous-time quantum walks on a line.
...
function quantum_walk_1d_wave(n, T)
    close all; clc;
