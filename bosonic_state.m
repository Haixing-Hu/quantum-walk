%BOSONIC_MEASURE  Measure the position state of a discrete-time quantum walk
%              on a line.
%
%   BOSONIC_MEASURE(s1, s2) Calculate the ferminoic state of two dependent 
%                       state.
...
function r = bosonic_state(s1, s2)
    n = size(s1);
