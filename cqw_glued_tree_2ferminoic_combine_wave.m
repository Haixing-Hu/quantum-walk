%CQW_GLUED_TREE_2FERMINOIC_WAVE Generate the combined probability wave of a 
%       continuous-time quantum walk of two ferminoics on a glued tree.
%
%  CQW_GLUED_TREE_2FERMINOIC_WAVE(n, random, k, a, b, s) Generate the combined probability    
...
function cqw_glued_tree_2ferminoic_combine_wave(n, random, k, a, b)       
    if (n < 1) 
