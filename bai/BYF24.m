...
for ii=1:length(z)
    d1=expm(-i*z(ii)*k1);
    for mm=1:length(x)
        e1(ii,mm)=abs(d1(ceil(mm/20),20)*mode(mm))^2;
        e2(ii,mm)=abs(d1(ceil(mm/20),20)*mode(mm)+d1(ceil(mm/20),21)*mode(mm))^2;
        e3(ii,mm)=abs(d1(ceil(mm/20),20)*mode(mm)+d1(ceil(mm/20),21)*mode(mm)+d1(ceil(mm/20),19)*mode(mm))^2;
        e4(ii,mm)=abs(d1(ceil(mm/20),20)*mode(mm)+d1(ceil(mm/20),21)*mode(mm)+d1(ceil(mm/20),19)*mode(mm)++d1(ceil(mm/20),18)*mode(mm))^2;
    end
end
