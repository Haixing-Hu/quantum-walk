%CQW_GLUED_TREE_2BOSONIC_WAVE Generate the combined probability wave of a 
%       continuous-time quantum walk of two bosonics on a glued tree.
%
%  CQW_GLUED_TREE_2BOSONIC_WAVE(n, random, k, a, b, s) Generate the combined probability    
...
function cqw_glued_tree_2bosonic_combine_wave(n, random, k, a, b)       
    if (n < 1) 
